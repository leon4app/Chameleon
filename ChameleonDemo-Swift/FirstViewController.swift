...
class FirstViewController: UITableViewController {
    ...
    func initChameleonColors() {
        ...
        navigationController?.navigationBar.titleTextAttributes = [NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): randomFlatColorContract]
        // Tab bar
